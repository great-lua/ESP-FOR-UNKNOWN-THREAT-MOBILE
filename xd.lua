...
local function GetTracerOrigin()
    ...
    -- Если устройство сенсорное и выбран "Mouse", принудительно ставим "Center"
...
local Window = Fluent:CreateWindow({
    ...
    Size = UDim2.new(0.8, 0, 0.6, 0), -- 80% ширины, 60% высоты экрана
    Acrylic = false,
    Theme = "Dark",
    -- MinimizeKey удалён (не работает на мобиле)
})
