...
local function GetTracerOrigin()
    ...
    -- На мобильных устройствах "Mouse" заменяем на "Center"
...
local function UpdateESP(player)
    ...
    -- ИСПРАВЛЕНО: получаем все три значения от WorldToViewportPoint
    ...
    -- Теперь используем topPos и bottomPos (Vector2)
    ...
    if Settings.SkeletonESP then
        ...
        local function drawLine(fromPart, toPart, line)
            ...
            -- ИСПРАВЛЕНО: получаем все три значения
...
-- ============================================================
-- GUI (адаптировано для мобильных устройств)
-- ============================================================
local Window = Fluent:CreateWindow({
    Title = "Unknown Threat ESP",
    SubTitle = "by Great | discord.gg/qR7ABr7f",
    TabWidth = 160,
    Size = UDim2.new(0.8, 0, 0.6, 0), -- адаптивный размер
    Acrylic = false,
    Theme = "Dark",
    -- MinimizeKey удалён (не работает на мобильных)
})
...
Fluent:Notify({
    Title = "Unknown Threat ESP (Mobile)",
    Content = "Loaded! Optimized for mobile devices.",
    Duration = 4
})
